...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__KHACHHAN__3214EC272B348F07");

            entity.ToTable("KHACHHANG_KHUYENMAI");

            entity.HasIndex(e => new { e.Makh, e.Makm }, "UQ_KH_KM").IsUnique();
            ...
            entity.HasOne(d => d.Khachhang).WithMany(p => p.KhachhangKhuyenmais)
                .HasForeignKey(d => d.Makh)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__KHACHHANG___MAKH__71D1E811");

            entity.HasOne(d => d.Khuyenmai).WithMany(p => p.KhachhangKhuyenmais)
                .HasForeignKey(d => d.Makm)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__KHACHHANG___MAKM__72C60C4A");
        });
